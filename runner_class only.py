...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        # selecting the image using the index
...
class Obstacle(pygame.sprite.Sprite):
    ...
    def update(self):
        self.animation_state()
        self.rect.x -= 6
        #destroy de obstacle if it is too much to the left
        self.destroy()
...
game_message = test_font.render('Press Start to Run',False,(111,196,169))
